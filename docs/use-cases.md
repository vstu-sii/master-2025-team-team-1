...
## Use-case диаграмма Автоматического парсинга и анализа резюме с генерацией вопросов для интервью

![Use Case диаграмма](diagrams/Parsing_resumes_use-case.png)
...
## Use-case диаграмма AI-анализа резюме с выявлением соответствия вакансии

![Use Case диаграмма](diagrams/Analysis_and_identification_of_skills_use-case.png)
...
## Use-case диаграмма Генерацией персонализированных вопросов для собеседования

![Use Case диаграмма](diagrams/Generate_questions_use-case.png)

---

| Атрибут | Описание |
|--------|---------|
| **Название** | Экспорт данных кандидатов |
...
## Use-case диаграмма Экспорта данных кандидатов

![Use Case диаграмма](diagrams/Export_data_use-case.png)
...
## Use-case диаграмма Браузерного расширения AI HR Assistant
Ниже представлена **Use-case UML диаграмма**, отражающая основные сценарии взаимодействия HR-специалиста с расширением **AI HR Assistant**. Диаграмма сфокусирована на потребностях HR-отделов среднего бизнеса.

![Use Case диаграмма](diagrams/AI_HR_Assistant_use-case.png)
